...
async def start_command(message: types.Message):
    with open('images/mainBanner.jpg','rb') as photo:
        await bot.send_photo(message.chat.id,photo,
                             ...
                             reply_markup=ikb_client_main_menu())
...
async def wifi_command(call: types.CallbackQuery):
    ...
    await bot.send_message(call.message.chat.id,'Назва мережі: WIFI \nПароль: 10651124',
                           reply_markup=ikb_client_back_to_main_menu())
...
async def open_bar_menu(call: types.CallbackQuery):
    ...
    with open('images/bar.jpeg','rb') as photo:
        await bot.send_photo(call.message.chat.id,photo,
                             caption='Меню нашого закладу',
                             reply_markup=ikb_client_bar())


async def open_rols(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть рол',reply_markup= await ikb_client_rols())

async def open_pizza(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть піцу',reply_markup= await ikb_client_pizza())

async def open_salats(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть салат',reply_markup= await ikb_client_salats())

async def open_first_dish(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть першу страву',reply_markup=  await ikb_client_first_dish())
async def open_second_dish(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть другу страву',reply_markup= await ikb_client_second_dish_type())

async def open_cold_snacks(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть холодну закуску',reply_markup= await ikb_client_cold_snacks())

async def open_warm_snacks (call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть гарячу закуску',reply_markup= await ikb_client_warm_snacks())

async def open_deserts(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть десерт',reply_markup= await ikb_client_desetrs())
async def open_sushi_phila(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть рол Філадельфія',
                           reply_markup= await ikb_client_sushi_phila())
...
async def open_second_dish_pig(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть другу страву з свинини',reply_markup= await ikb_client_second_dish_pig())

async def open_second_dish_chiken(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть другу страву з курки',reply_markup= await ikb_client_second_dish_chiken())

async def open_second_dish_fish(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть другу страву з риби',reply_markup= await ikb_client_second_dish_fish())

async def open_second_dish_side_dishes(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть гарнір',reply_markup= await ikb_client_second_dish_side_dishes())

async def open_second_dish_pasta(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть пасту',reply_markup= await ikb_client_second_dish_pasta())

async def open_second_dish_mangal(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть мангал',reply_markup= await ikb_client_second_dish_mangal())

async def open_drinks(call: types.CallbackQuery):
    await call.message.delete()
    await bot.send_message(call.message.chat.id,'Виберіть напій',reply_markup= await ikb_client_drinks())
...
def register_handlers_client(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(open_second_dish, text='second_dish')
